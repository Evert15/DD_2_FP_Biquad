...
HD_PWD='C:/Users/s_evm/workspace/project_adder.xpr/DD_2_FP_Biquad/DD_2_FP_Biquad.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DD2_FP_Biquad.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DD2_FP_Biquad.tcl
